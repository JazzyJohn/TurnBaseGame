...
namespace Render
{
    public class ArcRender : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector3 startPosition = transform.position + vertical_offset * Vector3.up;
            ...
            for (int i = 0; i < quality; i++)
            {
                ...
                pos_curr_min = startPosition + sphere_curr * dist_min;
                pos_curr_max = startPosition + sphere_curr * dist_max;

                pos_next_min = startPosition + sphere_next * dist_min;
                pos_next_max = startPosition + sphere_next * dist_max;
